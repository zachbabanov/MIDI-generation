...
if not os.path.exists("VAE\\data\\evaluation_plots"):
    os.mkdir("VAE\\data\\evaluation_plots")
...
plt.savefig("evaluation_plots\\"+dataset_selection+"\\Bar_graph_VAE_"+dataset_selection+".png")
...
plt.savefig("evaluation_plots\\"+dataset_selection+"\\Difference_Bar_graph_VAE_"+dataset_selection+".png")
# plt.show()
