...
def save_bar_graphs():
    ...
    plt.bar(
        ...
        width=barWidth,
        edgecolor="grey",
        label="Generated Music Note Frequency",
    )
    ...
    plt.bar(
        range(96), abs(dataset_frequency - gen_frequency), color="maroon", width=0.4
    )
    plt.xlabel("Note", fontweight="bold", fontsize=20)
